...
public class ConstantsTest {
    ...
    public void testConstants() {
        assertEquals(MISSING_PROPERTY_PREFIX, ConfigGeneratorImpl.MISSING_PROPERTY_PREFIX);
        assertEquals(MISSING_PROPERTY_SUFFIX, ConfigGeneratorImpl.MISSING_PROPERTY_SUFFIX);
        assertEquals(MISSING_PROPERTY_PATTERN, ConfigGeneratorImpl.MISSING_PROPERTY_PATTERN);
    }
